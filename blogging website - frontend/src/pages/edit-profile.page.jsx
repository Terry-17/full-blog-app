...
const EditProfile = () => {
    ...
    const handleDeleteAccount = () => {
        ...
        let confirmed = window.confirm("Are you sure you want to delete your account? This action cannot be undone.");

        if(!confirmed) return;

        if(!access_token) return toast.error("You must be signed in to delete your account");

        let loadingToast = toast.loading("Deleting account.....");

        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/delete-account", {}, {
            headers: {
                'Authorization': `Bearer ${access_token}`
            }
        })
        .then(() => {
            ...
            // clear session and redirect to home (logged-out view)
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="w-full">
                            ...
                            <p className="mt-1 text-slate-800">{ charactersLeft } characters left</p>

                            {/* <p className="my-6 text-slate-800">Add your social handles below</p> */}
...
<div className="mt-20 ">
                     <button className="text-white btn-light text-red-600 border-red-600 hover:bg-red-50 w-auto px-6" type="button" onClick={handleDeleteAccount}>Delete Account</button>
</div>
