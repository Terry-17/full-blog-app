...
const PageNotFound = () => {
    ...
    return (
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            ...
            <p className="text-slate-800 text-xl leading-7 -mt-8">The page you are looking for does not exists. Head back to the <Link to="/" className="text-black underline">home page</Link></p>

            <div className="mt-auto">
                <img src={ theme == "light" ? darkFullLogo : lightFullLogo } className="h-8 object-contain block mx-auto select-none" />
                <p className="mt-5 text-slate-800">Read millions of stories around the world</p>
            </div>
