        ...
        <>
            ...
            <div className="flex gap-6 justify-between">
                <div className="flex gap-3 items-center">
                    <button
                        onClick={handleLike}
                        className={"w-10 h-10 rounded-full flex items-center justify-center " + ( islikedByUser ? "bg-red/20 text-red" : "bg-yellow-5080" )}
                    >
                        <i className={"fi " + ( islikedByUser ? "fi-sr-heart" : "fi-rr-heart" )}></i>
                    </button>
                    <p className="text-xl text-slate-800">{ total_likes }</p>

                    <button
                        onClick={() => setCommentsWrapper(preVal => !preVal)}
                        className="w-10 h-10 rounded-full flex items-center justify-center bg-yellow-5080"
                    >
                        <i className="fi fi-rr-comment-dots"></i>
                    </button>
                    <p className="text-xl text-slate-800">{ total_comments }</p>
                </div>
                ...
                <div className="flex gap-6 items-center">

                    {
                        ...
                        <Link to={`/editor/${blog_id}`} className="underline hover:text-yellow-300">Edit</Link> : ""
                    }
