...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    return (
        <div className={"p-6 border-b border-grey border-l-black " + ( !seen ? "border-l-2" : "" )}>
            <div className="flex gap-5 mb-3">
                ...
                <div className="w-full">
...

                    {
                        ...
                        : 
                        <Link to={`/blog/${blog_id}`} className="font-medium text-slate-800 hover:underline line-clamp-1">{`"${title}"`}</Link>
            ...
            <div className="ml-14 pl-5 mt-3 text-slate-800 flex gap-8">
