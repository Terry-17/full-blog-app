...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    const LoadMoreRepliesButton = () => {
        ...
        let button = <button onClick={() => loadReplies({ skip: index - parentIndex, currentIndex: parentIndex })} className="text-slate-800 p-2 px-3 hover:bg-yellow-5030 rounded-md flex items-center gap-2">Load More Replies</button>;
    ...
    return (
        <div className="w-full" style={{ paddingLeft: `${leftVal * 10}px` }}>
            <div className="my-5 p-6 rounded-md border border-slate-800">
                ...
                <div className="flex gap-5 items-center mt-5">

                    {
                        ...
                        <button className="text-slate-800 p-2 px-3 hover:bg-slate-800/30 rounded-md flex items-center gap-2" onClick={hideReplies}>
                            <i className="fi fi-rs-comment-dots"></i>Hide Reply
                        </button> : 
                        <button className="text-slate-800 p-2 px-3 hover:bg-slate-800/30 rounded-md flex items-center gap-2" onClick={loadReplies}>
...

                    {
                        ...
                        <button className="p-2 px-3 rounded-md border border-slate-800 ml-auto hover:bg-red/30 hover:text-red flex items-center" onClick={deleteComment}>
