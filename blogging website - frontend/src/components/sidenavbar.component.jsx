        ...
        <>
            <section className="relative flex gap-10 py-0 m-0 max-md:flex-col">
                ...
                <div className="sticky top-[80px] z-30"> 
                    ...
                    <div className={"min-w-[200px] h-[calc(100vh-80px-60px)] md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-grey md:border-r absolute max-md:top-[64px] bg-amber-400/50 max-md:w-[calc(100%+80px)] max-md:px-16 max-md:-ml-7 duration-500 " + (!showSideNav ? "max-md:opacity-0 max-md:pointer-events-none" : "opacity-100 pointer-events-auto")}>

                        <h1 className="text-xl text-slate-800 mb-3">Dashboard</h1>
                        <hr className="border-slate-800 -ml-6 mb-8 mr-6" />
                        ...
                        <h1 className="text-xl text-slate-800 mt-20 mb-3">Settings</h1>
                        <hr className="border-slate-800 -ml-6 mb-8 mr-6" />
