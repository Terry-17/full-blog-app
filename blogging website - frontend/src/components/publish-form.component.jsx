        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="max-w-[550px] center">
                    <p className="text-slate-800 mb-1">Preview</p>
                ...
                <div className="border-slate-800 lg:border-1 lg:pl-8">
                    <p className="text-slate-800 mb-2 mt-9">Blog Title</p>
                    <input type="text" placeholder="Blog Title" defaultValue={title} className="input-box pl-4" onChange={handleBlogTitleChange} />

                    <p className="text-slate-800 mb-2 mt-9">Short description about your blog</p>
                    ...
                    <p className="mt-1 mb-4 text-slate-800 text-right" >{ tagLimit - tags.length } Tags left</p>
